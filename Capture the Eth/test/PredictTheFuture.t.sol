...
import {PredictTheFutureChallenge} from "../src/PredictTheFuture.sol";
...
contract PredictTheFuture is Test {
    ...
    function setUp() public {
        ...
        predictTheFutureChallenge = new PredictTheFutureChallenge{
            value: 1 ether
        }();
        vm.label(
            address(predictTheFutureChallenge),
            "PredictTheFutureChallenge[contract]"
        );
