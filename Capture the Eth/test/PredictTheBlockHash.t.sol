...
import {PredictTheBlockHashChallenge} from "../src/PredictTheBlockHash.sol";
...
contract PredictTheBlockHash is Test {
    ...
    function setUp() public {
        ...
        predictTheBlockHash = new PredictTheBlockHashChallenge{
            value: 1 ether
        }();
        vm.label(
            address(predictTheBlockHash),
            "PredictTheBlockHashChallenge[contract]"
        );
